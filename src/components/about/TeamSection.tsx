...
export default function TeamSection() {
  ...
  const members = t.raw("members") as { title: string; bio: string }[];

  return (
    <section id="team" className="section-padding bg-primary-dark relative overflow-hidden" aria-label="Our Team">
      ...
      <div className="container-xl relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {TEAM.map((member, i) => {
            const info = members[i] ?? { title: "", bio: "" };
            return (
              <ScrollReveal key={member.name} delay={i * 0.1} direction="up">
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5">
                    ...
                    <p className="text-accent text-xs font-semibold uppercase tracking-wider mt-0.5">{info.title}</p>
