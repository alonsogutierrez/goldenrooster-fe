...
const iconMap: Record<string, React.ElementType> = {
  Award, CheckCircle2, Star, Users,
};

export default function StatsSection() {
  return (
    <section
      className="relative bg-primary py-16 lg:py-20 overflow-hidden"
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 70% 100% at 50% 50%, rgba(74,123,157,0.15) 0%, transparent 70%)",
        }}
      />
